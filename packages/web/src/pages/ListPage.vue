...
// async function onClick(name: string, props: any) {
//   if (name == 'edit') {
//     router.push({ name: name, query: { app: props.cols[0].value } });
//   } else {
//     // TODO: open windows via intent

//     const tryToConnect = async (url) => {
//       try {
//         const data = await axios.get(url);
//         if (
//           data.data ==
...
//       } catch (e) {
//         console.log(e);
//         throw { message: 'app is still not installed yet' };
//       }
//     };

//     for (let i in apps.apps) {
//       if (apps.apps[i].appName == props.cols[0].value) {
//         const testUrl = 'https://' + apps.apps[i].ide;
//         if (name == 'preview') {
//           await tryToConnect(testUrl);
//           if (window.top == window) {
//             window.open('//' + apps.apps[i].entrance, '_blank');
//           } else {
//             await apps.openApplication({
//               appid: apps.apps[i].appID,
//               path: '',
//             });
//           }
//         } else if (name == 'coding') {
...
//           if (window.top == window) {
//             window.open('//' + apps.apps[i].ide, '_blank');
//           } else {
//             await apps.openApplication({
//               appid: apps.apps[i].appID,
//               path: '/proxy/3000/',
